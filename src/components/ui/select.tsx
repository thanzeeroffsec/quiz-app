...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 !w-full rounded-none  items-center justify-between  border border-slate-200 bg-white px-3 py-2 text-sm ring-offset-white placeholder:text-slate-500 focus:!border-0 focus:!ring-2 focus:!ring-gray-500/[0.5] focus:!outline-none  ",
      className
    )}
    {...props}
  >
